import { create, destroy, get, update } from '@/api/payment_methods'
...
export const usePaymentMethodsStore = defineStore('paymentMethods', {
    ...
    actions: {
        ...
        async create(payload: PaymentMethodsForm) {
            this.loading = true
            try {
        ...
        async update(uid: string, payload: PaymentMethodsForm) {
            this.loading = true
            try {
