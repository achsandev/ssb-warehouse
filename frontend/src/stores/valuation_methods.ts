import { create, destroy, get, update } from '@/api/valuation_methods'
import { defineStore } from 'pinia'
import { useMessageStore } from './message'

const message = useMessageStore()

export const useValuationMethodsStore = defineStore('valuationMethods', {
    state: () => ({
        data: [] as ValuationMethodsList[],
        pagination: {
            page: 1,
            per_page: 5,
            last_page: 1
    ...
    actions: {
        ...
        async create(payload: ValuationMethodsForm) {
            this.loading = true
            try {
        ...
        async update(uid: string, payload: ValuationMethodsForm) {
            this.loading = true
            try {
