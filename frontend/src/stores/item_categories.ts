import { create, destroy, get, update } from '@/api/item_categories'
...
export const useItemCategoriesStore = defineStore('itemCategories', {
    ...
    actions: {
        ...
        async create(payload: ItemCategoriesForm) {
            this.loading = true
            try {
        ...
        async update(uid: string, payload: ItemCategoriesForm) {
            this.loading = true
            try {
