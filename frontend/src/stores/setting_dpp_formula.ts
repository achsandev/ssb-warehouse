...
import { create, destroy, get, update } from '@/api/setting_dpp_formula'

const message = useMessageStore()

export const useSettingDppFormulaStore = defineStore('settingDppFormula', {
    state: () => ({
    ...
    actions: {
        ...
        async create(payload: SettingDppFormulaForm) {
            this.loading = true
            this.error = false
            try {
        ...
        async update(uid: string, payload: SettingDppFormulaForm) {
            this.loading = true
            this.error = false
            try {
