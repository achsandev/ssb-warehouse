...
import MovementCategoriesForm from '@/modules/movementcategories/components/MovementCategoriesForm.vue'
import ConfirmDeleteDialog from '@/components/common/ConfirmDeleteDialog.vue'
import DetailList from '@/components/common/DetailList.vue'
// Import Stores
import { useMovementCategoriesStore } from '@/stores/movement_categories'
// Import Composables
...
const store = useMovementCategoriesStore()
...
const formFields = reactive<MovementCategoriesList>({
    uid: '',
    name: '',
    description: '',
    created_at: '',
...
const handleActionMenu = (action: string, data: MovementCategoriesList) => {
    if (action === 'detail') {
...
const handleOpenDialog = (item: MovementCategoriesList | null) => {
    if (item) {
...
const handleOpenDetailDialog = (item: MovementCategoriesList) => {
    detailData.value = []
    resetForm()
    try {
        Object.assign(formFields, item)
