...
import UsageUnitsForm from '@/modules/usageunits/components/UsageUnitsForm.vue'
import ConfirmDeleteDialog from '@/components/common/ConfirmDeleteDialog.vue'
// Import Stores
import { useUsageUnitsStore } from '@/stores/usage_units'
// Import Composables
...
const store = useUsageUnitsStore()
...
const formFields = reactive<UsageUnitsList>({
    uid: '',
    name: '',
    created_at: '',
    updated_at: '',
...
// Functions
// =========================
const handleActionMenu = (action: string, data: UsageUnitsList) => {
    if (action === 'detail') {
...
const handleOpenDialog = (item: UsageUnitsList | null) => {
    if (item) {
...
const handleOpenDetailDialog = (item: UsageUnitsList) => {
    detailData.value = []
    resetForm()
    try {
        Object.assign(formFields, item)
...
const handleSubmit = (values: UsageUnitsForm) => {
