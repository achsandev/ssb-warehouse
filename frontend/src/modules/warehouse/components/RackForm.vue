 ...
 * `additional_info` kosong dikirim string kosong agar bentuk payload konsisten
 * dengan schema (yup `string().nullable()`).
 */
...
<template>
    ...
    >
        <v-card class="rounded-lg rack-form-card" :loading="saving">
            <!-- Header -->
            <v-toolbar color="transparent" density="comfortable" flat>
                <template #prepend>
                    <v-icon :icon="MdiViewGridOutline" color="primary" class="ms-2" />
                </template>
