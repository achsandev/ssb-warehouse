...
class UpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $sub_material_group_id = $this->route('sub_material_group')?->id
            ?? SubMaterialGroups::where('uid', $this->route('uid'))->value('id');
        ...
        return [
            ...
            'code' => [
                ...
                'string',
                'max:5',
                Rule::unique('wh_sub_material_groups', 'code')
