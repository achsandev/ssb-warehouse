...
return new class extends Migration
{
    ...
    {
        Schema::create('wh_stock_opname_detail', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('difference_qty', 15, 2)->nullable();
            ...
            $table->foreign('stock_opname_id')->references('id')->on('wh_stock_opname')->onDelete('cascade');
            $table->foreign('stock_unit_id')->references('id')->on('wh_stock_units')->onDelete('restrict');
            ...
            $table->foreign('warehouse_id')->references('id')->on('wh_warehouse')->onDelete('restrict');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('wh_stock_opname_detail');
    }
};
